package me.austinlm.extravaganza.proto;
...
import me.austinlm.extravaganza.proto.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
    ...
    private static final FieldAccessor<PlayerConnection> getConnection = Reflection.getField("{nms}.server.level.EntityPlayer", "b", PlayerConnection.class);
    private static final FieldAccessor<NetworkManager> getManager = Reflection.getField("{nms}.server.network.PlayerConnection", "a", NetworkManager.class);
    ...
    private static final FieldAccessor<List> getNetworkMarkers = Reflection.getField(serverConnectionClass, "g", List.class);
